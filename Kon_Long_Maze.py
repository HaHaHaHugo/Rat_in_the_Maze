...
pygame.display.set_caption("30x30 Maze - Manual & Auto Mode")
...
while running:
    ...
    if auto_mode and not game_over:
        ...
        if current_time - last_auto_move > auto_step_delay:
            if auto_path:
                player_pos = list(auto_path.pop(0))
    ...
    py = player_pos[1] * CELL_SIZE + 50 + CELL_SIZE // 2
    pygame.draw.circle(screen, RED, (px, py), CELL_SIZE // 2 - 2)
